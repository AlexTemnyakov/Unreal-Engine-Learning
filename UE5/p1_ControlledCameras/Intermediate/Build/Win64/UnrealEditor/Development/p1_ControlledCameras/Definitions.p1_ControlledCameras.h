#undef P1_CONTROLLEDCAMERAS_API
...
#define UE_PROJECT_NAME p1_ControlledCameras
#define UE_TARGET_NAME p1_ControlledCamerasEditor
...
#define P1_CONTROLLEDCAMERAS_API DLLEXPORT
